...
class PowerPointFactory {
    ...
    setTextColor(slide, color, indexOfShape, indexOfRowText) {
        this.pptFactory.setTextColor(slide, color, indexOfShape, indexOfRowText);
    }

    //add by me
    getTextColor(slide) {
        return this.pptFactory.getTextColor(slide);
    }

    getText(slide) {
        return this.pptFactory.getText(slide);
    }

    setText(slide, text, properties) {
        return this.pptFactory.setText(slide, text, properties);
    }

    getBackgroundColor(slide) {
        return this.pptFactory.getBackgroundColor(slide);
    }
