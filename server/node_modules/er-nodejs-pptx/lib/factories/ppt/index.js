...
class PptFactory {
    ...
    //add by me
    setTextColor(slide, color, indexOfShape, indexOfRowText) {
        this.slideFactory.setTextColor(slide, color, indexOfShape, indexOfRowText);
    }

    //add by me
    getTextColor(slide) {
        return this.slideFactory.getTextColor(slide);
    }

    getText(slide) {
        return this.slideFactory.getText(slide);
    }

    setText(slide, text, properties) {
        return this.slideFactory.setText(slide, text, properties);
    }

    getBackgroundColor(slide) {
        return this.slideFactory.getBackgroundColor(slide);
    }
    ...
    async addChart(slide, chart) {
        ...
        let workbookContentZipBinary = await workbookJSZip.generateAsync({ type: 'string' });
