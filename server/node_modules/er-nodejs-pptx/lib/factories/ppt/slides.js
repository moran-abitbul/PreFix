        ...
        for (let i in slideContent['p:spTree'][0]['p:sp']) {
            if (slideContent['p:spTree'] !== undefined) {
                if (slideContent['p:spTree'][0]['p:sp'][i] === undefined) {
                    ...
                    let rows = slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'].length;
                    for (let row = 0; row < rows; row++) {
                        if (slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'][row]['a:r'] !== undefined) {
                            if (slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'][row]['a:r'][0]['a:rPr'][0]['a:solidFill'] !== undefined) {
                                if (slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'][row]['a:r'][0]['a:rPr'][0]['a:solidFill'][0]['a:srgbClr'] !== undefined) {
                                    let valColor = slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'][row]['a:r'][0]['a:rPr'][0]['a:solidFill'][0]['a:srgbClr'][0]['$']['val'];
                                ...
                                slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'][row]['a:r'][0]['a:rPr'][0]['a:solidFill'] = defultColorBlock;
                                let valColor = slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'][row]['a:r'][0]['a:rPr'][0]['a:solidFill'][0]['a:srgbClr'][0]['$']['val'];
                                shapeColorArray[i].push(valColor);
                            }
                        }
