...
class SlideFactory {
    ...
    //add by me
    setTextColor(slide, color, i, j) { //i-1, j-1
        let slideKey = `ppt/slides/${slide.name}.xml`;
        let slideContent = this.content[slideKey]['p:sld']['p:cSld'][0];
                    ...
                    for (let row = 0; row < rows; row++) {
                        if (slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'][row]['a:r'] !== undefined) {
                            if (slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'][row]['a:r'][0]['a:rPr'][0]['a:solidFill'] !== undefined) {
                                ...
                                shapeColorArray[i].push("ffffff"); //defult black color get a white color
                            }
                        }
                    }
                }
    ...
    getText(slide) {
        ...
        var shapeSizeTextArray = new Array(); //arr size
        for (let i in slideContent['p:spTree'][0]['p:sp']) {
            if (slideContent['p:spTree'] !== undefined) {
                if (slideContent['p:spTree'][0]['p:sp'][i] === undefined) {
                    slideContent['p:spTree'][0]['p:sp'][i] = [{}];
                    ...
                    shapeSizeTextArray[i] = new Array(); //size text string
                    //shapeTextArray[i][0] = ""
                            ...
                            if (slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'][paragraph]['a:r'].length > 1) { //In case the line splits
                                for (let word in slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'][paragraph]['a:r']) {
                                    if (slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'][paragraph]['a:r'][word]['a:t'] !== undefined) {
                                        shapeTextArray[i] += (slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'][paragraph]['a:r'][word]['a:t']);
                                        if (slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'][paragraph]['a:r'][word]['a:rPr'][0]['$']['sz'] != undefined) {
                                            shapeSizeTextArray[i].push(slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'][paragraph]['a:r'][word]['a:rPr'][0]['$']['sz'])
                                        } else {
                                            //shapeTextArray[i][1] = " "
                                            shapeSizeTextArray[i].push(" ")
                                        }
                                    }
                                }
                                shapeTextArray[i] += (".")//for each a:t set point
                            } else {
                                if (slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'][paragraph]['a:r'][0]['a:t'] !== undefined) {
                                    shapeTextArray[i].push(slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'][paragraph]['a:r'][0]['a:t'])
                                    //shapeTextArray[i][0] += "."
                                    shapeSizeTextArray[i].push(slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'][paragraph]['a:r'][0]['a:rPr'][0]['$']['sz'])
        ...
        return [shapeTextArray, shapeSizeTextArray];
    }
    ...
    //                             for (let word in slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'][paragraph]['a:r']) {
    //                                 if (slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'][paragraph]['a:r'][word]['a:t'] !== undefined) {
    //                                     delete slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'][paragraph]['a:r'][word]['a:t'];
    //                                 }
    //                                 slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'][paragraph]['a:r'][word]['a:t'] =  [PptFactoryHelper.addTextValuesToBlock]
    //                             }

    //                         } else {
    //                             if (slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'][paragraph]['a:r'][0]['a:t'] !== undefined) {
    //                                 shapeTextArray[i][0] += slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'][paragraph]['a:r'][0]['a:t'];
    //                                 shapeTextArray[i][0] += "."
    //                                 shapeTextArray[i][1] = slideContent['p:spTree'][0]['p:sp'][i]['p:txBody'][0]['a:p'][paragraph]['a:r'][0]['a:rPr'][0]['$']['sz']
