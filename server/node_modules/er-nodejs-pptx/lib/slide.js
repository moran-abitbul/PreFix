...
const color = require('./factories/ppt/slides')
...
class Slide {
    ...
    //add by me
    textColorToChange(color, indexOfShape, indexOfRowText) {
        this.powerPointFactory.setTextColor(this, color, indexOfShape, indexOfRowText);
    }

    //add by me
    getArrColors() {
        return this.powerPointFactory.getTextColor(this);
    }

    getArrText() {
        return this.powerPointFactory.getText(this);
    }

    setArrText(text, properties) {
        return this.powerPointFactory.setText(this, text, properties);
    }

    getBackgroundColor() {
        return this.powerPointFactory.getBackgroundColor(this);
    }
    ...
    //add by me
    checkPic() {
        let slideContent = this.content['p:sld']['p:cSld'][0];
        if (slideContent['p:spTree'][0]['p:pic'] !== undefined) {
            return true;
        } else {
            return false;
        }
