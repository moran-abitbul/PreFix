  ...
  _createClass(EvaluatorBase, [{
    ...
    value: function evalBinaryOperation(node) {
      ...
      var isNumbers = [left, right].every(function (v) {
        return Utils.getType(v) === ValueType.Number;
      });
      var isColors = [left, right].every(function (v) {
        return Utils.getType(v) === ValueType.Color;
      });
      var isColorAndNumber = Utils.getType(left) === ValueType.Color && Utils.getType(right) === ValueType.Number;
      var isNumberAndColor = Utils.getType(left) === ValueType.Number && Utils.getType(right) === ValueType.Color;
      ...
      Utils.throwError("".concat(Utils.getObjKey(ValueType, Utils.getType(left)), " ") + "and ".concat(Utils.getObjKey(ValueType, Utils.getType(right)), " ") + "is invalid operand types or sequence for operator '".concat(node.operator, "'"), node.$loc);
    }
  }, {
...
export { EvaluatorBase as default };
